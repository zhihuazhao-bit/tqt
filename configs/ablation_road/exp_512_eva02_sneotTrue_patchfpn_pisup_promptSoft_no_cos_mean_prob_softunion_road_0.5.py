"""
F2p-mean-prob-soft (Road3D 512, T=0.5): SNE + OT 融合 (prior=prob, mean 池化, softunion) + Patch-FPN + pi 深监督 + Prompt(Soft, EVA02 权重)
- 尺寸: 512x512
- 数据集: Road3D
- 权重: EVA02_CLIP_B (原始)
- SNE: 有 (backbone-ot)
...
ot_score_prior_temperature = 0.5
ot_cost_type = 'cos'
...
exp_name = 'ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_0.5'
