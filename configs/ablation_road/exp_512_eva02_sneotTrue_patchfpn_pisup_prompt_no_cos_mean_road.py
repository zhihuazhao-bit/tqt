"""
F2p-mean-cos (Road3D 512): SNE + OT 融合 (有先验, mean 池化) + Patch-FPN + pi 深监督 + Prompt (EVA02 权重)
- 尺寸: 512x512
- 数据集: Road3D
- 权重: EVA02_CLIP_B (原始)
- SNE: 有 (backbone-ot)
...
exp_name = 'ablation_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_road'
