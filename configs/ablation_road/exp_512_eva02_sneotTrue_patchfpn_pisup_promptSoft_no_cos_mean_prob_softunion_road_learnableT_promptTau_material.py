"""
F2p-mean-prob-soft-learnableT-promptTau-material (Road3D 512): SNE + OT 融合 + Patch-FPN + pi 深监督 + Prompt(Soft) + Material Classification
- 尺寸: 512x512
- 数据集: Road3D
- 权重: EVA02_CLIP_B
- SNE: 有 (backbone-ot)
...
- Material Classification: True (增加材质分类，场景库从24扩展到240)
"""
_base_ = [
...
use_material_cls = True  # ✅ 启用材质分类 (场景库从24扩展到240)
# ============================================================================
...
exp_name = 'ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_learnableT_promptTau_material'
...
model = dict(
    ...
    tau=tau,
    use_material_cls=use_material_cls,  # ✅ 材质分类
    eva_clip=dict(
