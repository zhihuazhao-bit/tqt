"""
F2p-proj-prob-soft-learnableT-promptTau (Road3D 512): SNE + OT 融合 (proj) + Patch-FPN + pi 深监督 + Prompt(Soft) + Learnable T + Prompt uses Tau
- 尺寸: 512x512
- 数据集: Road3D
- 权重: EVA02_CLIP_B
- SNE: 有 (backbone-ot)
...
exp_name = 'ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_proj_prob_softunion_road_learnableT_promptTau'
