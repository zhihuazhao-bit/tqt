"""
DenseVLM-learnableT-promptTau (Road3D 512): SNE + OT 融合 + Patch-FPN + pi 深监督 + Prompt(Soft) + Learnable T + Prompt uses Tau
- 尺寸: 512x512
- 数据集: Road3D
- 权重: DenseVLM (densevlm_coco_6_save6_512_eva_vib16_12layers.pt)
- SNE: 有 (backbone-ot)
- OT Prior: True (prob)
- OT SoftUnion: True
- OT Cost: cos
...
exp_name = 'ablation_512_densevlm_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_learnableT_promptTau'
