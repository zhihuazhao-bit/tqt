"""
Proj-learnableT-promptTau (Road3D 512): SNE + Proj 融合 + Patch-FPN + pi 深监督 + Prompt(Soft) + Learnable T + Prompt uses Tau
- 尺寸: 512x512
- 数据集: Road3D
- 权重: EVA02_CLIP_B
- SNE: 有 (backbone-proj) - 使用投影融合
- OT Prior: True (prob)
- OT SoftUnion: True
- OT Cost: cos
...
patch_fpn = True
supervise_ot_pi = False  # proj 模式不使用 OT pi 监督
# ============================================================================
...
exp_name = 'ablation_512_eva02_sneProjTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_learnableT_promptTau'
