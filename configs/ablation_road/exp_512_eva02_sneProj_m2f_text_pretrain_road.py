"""
消融实验 #2: SNE Proj + M2F Decoder + Text Pretrain Only (Road3D)
- 基于: exp_512_eva02_sneProj_learnable_only_m2f_decoder_road.py
- text_pretrain=True, image_pretrain=False
- prompt_cls=False (使用 traversable/non-traversable 描述)
"""
_base_ = [
...
prompt_cls = False  # 不使用场景解耦，使用基本 traversable/non-traversable 描述
# ============================================================================
...
exp_name = 'ablation_512_eva02_sneProj_m2f_text_pretrain_road'
