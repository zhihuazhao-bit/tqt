"""
消融实验 #1: SNE Proj + Learnable Only + M2F Decoder + 无预训练权重 (Road3D)
- 基于: exp_512_eva02_sneProj_learnable_only_m2f_decoder_road.py
- text_pretrain=False, image_pretrain=False
- prompt_cls=True, prompt_cls_type='learnable_only'
"""
_base_ = [
...
exp_name = 'ablation_512_eva02_sneProj_m2f_no_pretrain_road'
