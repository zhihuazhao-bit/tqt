"""
消融实验: SNE-OT + Learnable Only (Road3D 512)
- 尺寸: 512x512
- 数据集: Road3D
- 权重: EVA02_CLIP_B
- SNE: 有 (backbone-ot)
...
- Patch-FPN: True
- Pi Supervision: True
- Prompt: learnable_only (仅可学习向量，无文本编码)
- 用途: 验证在完整OT架构下，文本模态的必要性
...
exp_name = 'ablation_512_eva02_sneotTrue_patchfpn_pisup_learnable_only_road'
