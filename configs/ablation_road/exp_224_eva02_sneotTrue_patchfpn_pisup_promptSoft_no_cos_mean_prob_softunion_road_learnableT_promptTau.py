"""
F2p-mean-prob-soft-learnableT-promptTau (Road3D 224): SNE + OT 融合 + Patch-FPN + pi 深监督 + Prompt(Soft) + Learnable T + Prompt uses Tau
- 尺寸: 224x224
- 数据集: Road3D
- 权重: EVA02_CLIP_B
- SNE: 有 (backbone-ot)
...
_base_ = [
    ...
    '../_base_/datasets/road2road-224.py']
...
exp_name = 'ablation_224_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_learnableT_promptTau'
