"""
F2p-mean-prob-soft (Road3D): SNE + OT 融合 (prior=prob, mean 池化, softunion) + Patch-FPN + pi 深监督 + Prompt (EVA02 权重)
- 尺寸: 224x224
- 数据集: Road3D
- 权重: EVA02_CLIP_B (原始)
- SNE: 有 (backbone-ot)
...
exp_name = 'ablation_224_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion_road'
