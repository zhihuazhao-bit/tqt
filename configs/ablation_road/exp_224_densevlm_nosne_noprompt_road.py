"""
消融实验 B2: 预训练权重对比 - DenseVLM
- 尺寸: 224x224
- 权重: densevlm_coco (COCO微调)
- SNE: 无
- Prompt: 无
"""
_base_ = [
...
pretrained_weight = 'weight/pretrained/densevlm_coco_6_save6_512_eva_vib16_12layers.pt'  # DenseVLM COCO 微调权重
use_sne = False
...
exp_name = 'ablation_224_densevlm_nosne_noprompt_road'
