"""
F2p-mean-prob-soft-fixedT0.01-promptTau (ORFD 512): SNE + OT 融合 + Patch-FPN + pi 深监督 + Prompt(Soft) + Fixed T=0.01 + Learnable Tau
- 尺寸: 512x512
- 数据集: ORFD
- 权重: EVA02_CLIP_B
- SNE: 有 (backbone-ot)
...
exp_name = 'ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_fixedT0.01_promptTau'
