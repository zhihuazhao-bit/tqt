"""
消融实验 #8: SNE OT + Patch-FPN + Full Pretrain + No PromptCls (ORFD)
- 基于: #7
- text_pretrain=True, image_pretrain=True
- prompt_cls=False (不使用场景解耦)
"""
_base_ = [
...
exp_name = 'ablation_512_eva02_sneot_patchfpn_full_pretrain_no_promptcls'
...
model = dict(
    ...
    visual_reg=True, textual_reg=True)
