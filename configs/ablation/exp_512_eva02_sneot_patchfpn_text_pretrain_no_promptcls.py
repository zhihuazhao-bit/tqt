"""
消融实验 #7: SNE OT + Patch-FPN + Text Pretrain + No PromptCls (ORFD)
- 基于: #6
...
exp_name = 'ablation_512_eva02_sneot_patchfpn_text_pretrain_no_promptcls'
...
model = dict(
    ...
    visual_reg=False, textual_reg=True)
