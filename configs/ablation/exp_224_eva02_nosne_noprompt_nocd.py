"""
消融实验 A1-nc: 基准-小尺寸 (无 Context Decoder)
- 尺寸: 224x224
- 权重: EVA02_CLIP_B (原始)
- SNE: 无
- Prompt: 无
...
prompt_cls = False
use_context_decoder = False  # 关闭 context decoder
# ============================================================================
...
exp_name = 'ablation_224_eva02_nosne_noprompt_nocd'
...
model = dict(
    ...
    use_context_decoder=use_context_decoder,
