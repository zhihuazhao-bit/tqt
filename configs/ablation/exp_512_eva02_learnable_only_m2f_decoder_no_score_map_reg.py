"""
消融实验: Learnable Only + 标准 Mask2Former Pixel Decoder + 无 Vision-Language Score Map 正则化 (ORFD 数据集)
- 尺寸: 512x512
- 权重: EVA02_CLIP_B (原始)
- SNE: 无
...
- 对比 exp_512_eva02_learnable_only_m2f_decoder.py (使用 score_map 正则化)
"""
_base_ = [
...
exp_name = 'ablation_512_eva02_learnable_only_m2f_decoder_no_score_map_reg'
