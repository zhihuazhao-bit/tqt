"""
DenseVLM-learnableT-promptTau (ORFD 512): SNE + OT 融合 + Patch-FPN + pi 深监督 + Prompt(Soft) + Learnable T + Prompt uses Tau
- 尺寸: 512x512
- 数据集: ORFD
...
exp_name = 'ablation_512_densevlm_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_learnableT_promptTau'
