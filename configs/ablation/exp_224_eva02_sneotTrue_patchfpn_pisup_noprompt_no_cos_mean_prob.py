"""
消融实验 F2c+pi (mean, cos, prob nu): SNE + OT 融合 (prior=prob, mean 池化) + Patch-FPN + pi 深监督 (EVA02 权重, ORFD)
- 尺寸: 224x224
- 权重: EVA02_CLIP_B (原始)
...
对比实验: mean-cos + prob nu vs mean-cos + argmax nu
"""
_base_ = [
...
exp_name = 'ablation_224_eva02_sneotTrue_patchfpn_pisup_noprompt_no_cos_mean_prob'
