_base_ = [
    ...
    '../_base_/datasets/road2road-512-weather-traversable-cls-tqt-720.py']
per_gpu = 16
...
model = dict(
    ...
    decode_head=dict(
        type='tqtHead',
        in_channels=[visual_feature_dim*2, visual_feature_dim*2, visual_feature_dim*2, visual_feature_dim*2],
        feat_channels=256,
        out_channels=256,
        in_index=[0, 1, 2, 3],
    ...
    train_cfg=dict(
        img_sne_save_path = './work_dirs/sne/tqt_b_weather_traversable-road3d-384x640',
    ),
    test_cfg=dict(
        # mode='slide',
        mode = 'whole',
        ...
        attn_save_dir='./work_dirs/attns/tqt_b_weather_traversable-road3d'
        )
)
