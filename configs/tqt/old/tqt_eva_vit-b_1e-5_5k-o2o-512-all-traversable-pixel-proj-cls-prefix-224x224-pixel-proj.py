_base_ = [
    ...
    '../_base_/datasets/orfd2orfd-512-all-traversable-cls-tqt-224.py']
per_gpu = 16
...
feature_fusion_phase = 'pixel' # 'pixel' or 'context'
feature_fusion_mode = 'proj' # 'proj' or 'add' or 'concat'
decoder_dim = visual_feature_dim*2 if feature_fusion_mode == 'concat' and feature_fusion_phase == 'pixel' else visual_feature_dim
model = dict(
    type='tqt_EVA_CLIP',
    ...
    use_sne=True,
    use_cross_attn=True,
    feature_phase=feature_fusion_phase, 
    feature_mode=feature_fusion_mode,    
    eva_clip=dict(
    ...
    train_cfg=dict(
        img_sne_save_path = './work_dirs/sne/tqt_b_all_traversable-road3d-384x640',
    ),
    test_cfg=dict(
        # mode='slide',
        mode = 'whole',
        ...
        attn_save_dir='./work_dirs/attns/tqt_b_all_traversable-road3d'
        )
)
