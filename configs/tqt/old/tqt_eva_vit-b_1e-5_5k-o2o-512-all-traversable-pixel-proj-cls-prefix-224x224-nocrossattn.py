...
feature_fusion_mode = 'pixel'
decoder_dim = visual_feature_dim*2 if feature_fusion_mode == 'pixel' else visual_feature_dim
model = dict(
    type='tqt_EVA_CLIP',
    ...
    feature_phase=feature_fusion_mode, # 'pixel' or 'context'
