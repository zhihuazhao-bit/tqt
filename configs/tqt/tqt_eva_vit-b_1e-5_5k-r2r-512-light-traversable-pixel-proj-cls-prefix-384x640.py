_base_ = [
    ...
    '../_base_/datasets/road2road-512-light-traversable-cls-tqt-720.py']
per_gpu = 16
...
model = dict(
    ...
    train_cfg=dict(
        img_sne_save_path = './work_dirs/sne/tqt_b_light_traversable-road3d-384x640',
    ),
    test_cfg=dict(
        # mode='slide',
        mode = 'whole',
        ...
        attn_save_dir='./work_dirs/attns/tqt_b_light_traversable-road3d'
        )
)
