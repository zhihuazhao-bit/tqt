_base_ = [
    ...
    '../_base_/datasets/orfd2orfd-512-sun-traversable.py']
...
model = dict(
    ...
    decode_head=dict(
        ...
        pixel_decoder=dict(
            ...
            return_attn_weights=True, # 1. 新增参数
            encoder=dict(
                type='AttnDetrTransformerDecoder',
                return_intermediate=True,
                num_layers=6,
                transformerlayers=dict(
                    type='AttnDetrTransformerDecoderLayer',
                    attn_cfgs=[
