...
ABLATION_EXPERIMENTS = {
    ...
    'G2p-mean-cos-soft': {
        ...
        'desc': '512 + EVA02 + SNE(OT,prior=T, cos, mean) + Patch-FPN + piSup + Prompt(Soft)',
        'size': 512,
        'weight': 'EVA02',
        'sne': True,
        'sne_fusion_stage': 'backbone',
        ...
        'pi_sup': True,
        'csv_orfd': '',
        'csv_road3d': '/root/tqdm/work_dirs/ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_road/20251217_1300/exp_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_road/test_results/exp_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_road/testing_eval_file_stats_20251218_110807.csv',
    },

    'G2p-mean-cos-prob-soft': {
        'name': 'ablation_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion',
        'desc': '512 + EVA02 + SNE(OT,prior=T, cos, mean) + Patch-FPN + piSup + Prompt',
        'size': 512,
        'weight': 'EVA02',
        'sne': True,
        ...
        'pi_sup': True,
        'csv_orfd': '',
        'csv_road3d': '/root/tqdm/work_dirs/ablation_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion_road/20251216_1157/exp_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion_road/test_results/exp_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion_road/testing_eval_file_stats_20251217_102640.csv',
    },

    'G2p-mean-cos-prob-soft-0.5-soft': {
        'name': 'ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_0.5',
        'desc': '512 + EVA02 + SNE(OT,prior=prob,T=0.5, softunion, cos, mean) + Patch-FPN + piSup + Prompt(Soft)',
        'size': 512,
        'weight': 'EVA02',
        'sne': True,
        'sne_fusion_stage': 'backbone',
        ...
        'pi_sup': True,
        'csv_orfd': '',
        'csv_road3d': '/root/tqdm/work_dirs/ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_0.5/20251217_1304/exp_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_0.5/test_results/exp_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_0/testing_eval_file_stats_20251218_095416.csv',
    },

    'G2p-mean-cos-prob-soft-0.5': {
        'name': 'ablation_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion_road_0.5',
        'desc': '512 + EVA02 + SNE(OT,prior=prob,T=0.5, softunion, cos, mean) + Patch-FPN + piSup + Prompt',
        'size': 512,
        'weight': 'EVA02',
        'sne': True,
        'sne_fusion_stage': 'backbone',
        ...
        'pi_sup': True,
        'csv_orfd': '',
        'csv_road3d': '/root/tqdm/work_dirs/ablation_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion_road_0.5/20251217_1304/exp_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion_road_0.5/test_results/exp_512_eva02_sneotTrue_patchfpn_pisup_prompt_no_cos_mean_prob_softunion_road_0/testing_eval_file_stats_20251218_102929.csv',
    },

    'F2pSoft-learnableT-promptTau-1': {
        'name': 'ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_road_learnableT_promptTau',
        'desc': '512 + EVA02 + SNE(OT,prior=prob, Learnable T, cos, mean, softunion) + Patch-FPN + piSup + Prompt(Soft, uses Tau)',
        'size': 512,
        'weight': 'EVA02',
        'sne': True,
        'sne_fusion_stage': 'backbone',
    ...
    'F2pSoft-learnableT-promptTau-orfd': {
        ...
        'patch_fpn': True,
        'pi_sup': True,
        'csv_orfd': '',  # TODO: 填入 ORFD 测试结果 CSV 路径
        'csv_road3d': '',
    },

    'F2pSoft-learnableT-promptTau-224': {
        'name': 'ablation_224_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_mean_prob_softunion_learnableT_promptTau',
        'desc': '224 + EVA02 + SNE(OT,prior=prob, Learnable T, cos, mean, softunion) + Patch-FPN + piSup + Prompt(Soft, uses Tau)',
        'size': 224,
        'weight': 'EVA02',
        'sne': True,
        'sne_fusion_stage': 'backbone',
    ...
    'F2pSoft-proj-learnableT-promptTau': {
        'name': 'ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_proj_prob_softunion_road_learnableT_promptTau',
        'desc': '512 + EVA02 + SNE(OT,prior=prob, Learnable T, cos, proj, softunion) + Patch-FPN + piSup + Prompt(Soft, uses Tau)',
        'size': 512,
        'weight': 'EVA02',
        'sne': True,
        'sne_fusion_stage': 'backbone',
        ...
        'pi_sup': True,
        'csv_orfd': '',
        'csv_road3d': '/root/tqdm/work_dirs/ablation_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_proj_prob_softunion_road_learnableT_promptTau/20251218_1243/exp_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_proj_prob_softunion_road_learnableT_promptTau/test_results/exp_512_eva02_sneotTrue_patchfpn_pisup_promptSoft_no_cos_proj_prob_softunion_road_learnableT_promptTau/testing_eval_file_stats_20251219_105252.csv',
    },
