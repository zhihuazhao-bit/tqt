...
# python train.py /root/tqdm/configs/tqdm/tqdm_eva_vit-l_1e-5_20k-g2c-512.py --launcher none --gpus 2 --seed 2023
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=r'/root/tqdm/configs/tqdm/tqdm_eva_vit-b_1e-5_5k-o2o-512-sufficient-traversable-sne.py',
