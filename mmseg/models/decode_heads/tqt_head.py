...
class tqtHead(BaseDecodeHead):
    ...
    def forward(self, feats, texts, img_metas, sne_feature=None, return_mask_features=False, get_similarity=False): ### need texts for pixel_decoder !
        """Forward function.
